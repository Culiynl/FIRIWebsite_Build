...
const ICON_TOOLS = `<svg viewBox="0 t-shirt 0 24 24"><path d="M16 11.2V3.425a1.5 1.5 0 0 0-3 0V10h-2V6.425a1.5 1.5 0 0 0-3 0V10H6V8.425a1.5 1.5 0 0 0-3 0v12.15a1.5 1.5 0 0 0 3 0V12h2v4.575a1.5 1.5 0 0 0 3 0V18h2v2.575a1.5 1.5 0 0 0 3 0v-9.35a3.503 3.503 0 0 0-2-.025Z" fill="currentColor"></path></svg>`;
        ...
        <div class="results-layout">
            <div class="results-main">
                ...
                <div class="project-ideas-grid">
                    ${state.generatedProjects.map(renderProjectIdeaCard).join('')}
...
function renderProjectIdeaCard(project: ProjectIdea) {
    ...
    return `
        <div class="project-idea-card card">
            ...
            <button class="select-project-btn" data-project-title="${project.title}" disabled title="Coming Soon">Select & Develop this Idea</button>
        </div>
    `;
}
