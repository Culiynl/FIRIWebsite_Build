...
const ICON_DELETE = `<svg viewBox="0 0 24 24" fill="currentColor" width="18" height="18"><path d="M7 6V3C7 2.44772 7.44772 2 8 2H16C16.5523 2 17 2.44772 17 3V6H22V8H2V6H7ZM9 4V6H15V4H9Z"></path><path d="M4 9V20C4 21.1046 4.89543 22 6 22H18C19.1046 22 20 21.1046 20 20V9H4ZM8 11H10V18H8V11ZM14 11H16V18H14V11Z"></path></svg>`;
...
async function handleDeleteProject(event: Event) {
    ...
    try {
        await db.collection("users").doc(state.user.uid).collection("projects").doc(projectId).delete();
    ...
    <div class="user-profile">
      ${!state.isGuest ? `
        <button class="token-counter-btn ${hasLowTokens ? 'low-tokens' : ''}" id="token-upgrade-btn">
            <div>
                ${ICON_TOKEN}
                <div class="value">${state.tokens.toLocaleString()}</div>
            </div>
            <div class="label">Research Tokens</div>
        </button>
      ` : ''}
      <div class="user-info">
