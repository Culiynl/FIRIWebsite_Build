...
function renderProjectView() {
    ...
    const { title, description, category, impact, novelty, rigor, wowFactor, resourcesHtml } = state.selectedProject;
...
async function handleSelectProject(event: Event) {
    ...
    try {
        const projectData: ProjectIdea = { ...selectedProject, createdAt: new Date() };
