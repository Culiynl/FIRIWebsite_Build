...
// Define admin UIDs (for demo purposes, real app would use a more secure method)
const ADMIN_UIDS = ['YOUR_ADMIN_UID_1', 'YOUR_ADMIN_UID_2']; // Replace with actual Firebase UIDs of admins
            ...
            return `
              <div class="chat-column">
                  ...
                  <div id="chat-container" aria-live="polite">
                      ${state.systemInstruction && state.chatHistory.length === 0 && !state.isLoading ? // Only show initial judge message if it's the start
